...
export default function ContactPage() {
  ...
  const onSubmit = (data: ContactFormData) => {
    ...
    alert('Thank you for your message! We will get back to you soon. (Note: This is a demo - form submission will be enabled in Phase 2)');
    reset();
  };
        ...
        <div className="max-w-3xl mx-auto">
          <div className="mb-12">
            ...
            <p className="text-lg text-airbnb-gray">
              Have questions or ready to plan your spiritual journey? We're here to help.
            </p>
          </div>

          <div className="bg-white border border-airbnb-border rounded-xl p-8 md:p-10 mb-12">
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div>
                ...
                <select
                  {...register('package')}
                  className="w-full px-4 py-3 border border-airbnb-border rounded-lg focus:outline-none focus:ring-2 focus:ring-airbnb-red focus:border-airbnb-red"
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center p-6 bg-airbnb-surface rounded-xl">
              <div className="w-12 h-12 rounded-full bg-white flex items-center justify-center mx-auto mb-4 shadow-sm">
                <svg className="w-6 h-6 text-airbnb-red" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
              </div>
              <h3 className="font-semibold text-airbnb-black mb-2">Email</h3>
              <p className="text-sm text-airbnb-gray">info@spiritualyatra.com</p>
            </div>
