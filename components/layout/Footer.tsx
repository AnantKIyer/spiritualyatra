        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a
                href="#"
                className="w-10 h-10 rounded-full bg-accent-500 flex items-center justify-center text-white hover:bg-accent-600 transition-all material-elevation-2 hover:material-elevation-3"
                aria-label="Facebook"
              >
                <svg
                  className="w-5 h-5"
              ...
              <a
                href="#"
                className="w-10 h-10 rounded-full bg-secondary-500 flex items-center justify-center text-white hover:bg-secondary-600 transition-all material-elevation-2 hover:material-elevation-3"
                aria-label="Twitter"
              >
                <svg
                  className="w-5 h-5"
